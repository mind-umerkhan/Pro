        ...
        <div class="container">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header d-flex flex-row justify-content-between" style="background-color: #0072b1">
                                <a href="#" class="nav-link text-white">Job Lists</a>
                            </div>
                            <!-- /.card-header -->
                            <div class="card-body table-responsive">
                                <table id="example" class="table table-bordered table-striped">
                                    <thead>
                                        <tr style="background-color: #0072b1; color:wheat;">
                                            {{-- <th>Company Name</th> --}}
                                            <th>Province</th>
                                            <th>Employer</th>
